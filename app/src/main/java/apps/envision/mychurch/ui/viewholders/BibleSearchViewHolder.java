...
public class BibleSearchViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private TextView title,content,amp,kjv,nkjv,msg,nlt,niv,nrsv;
    ...
    public BibleSearchViewHolder(View itemView, BibleClickListener bibleClickListener) {
        super(itemView);
    ...
    public void bind(Bible bible, String query){
        this.bible = bible;
        this.query = query;
        ...
        Spanny spanny = new Spanny(String.valueOf(bible.getBook() +" "+ bible.getChapter())+":"+bible.getVerse(), new StyleSpan(Typeface.BOLD));
    ...
    private void setText(){
        ...
        spanny.findAndSpan(query, UnderlineSpan::new);
