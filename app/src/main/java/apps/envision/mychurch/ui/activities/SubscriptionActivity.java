...
public class SubscriptionActivity extends AppCompatActivity implements BillingProvider, LocalMessageCallback {
    ...
    public void handleMessage(@NonNull LocalMessage localMessage) {
        ...
        if(localMessage.getId() == R.id.request_login){
            new Utility(SubscriptionActivity.this).show_create_account_alert();
        }
