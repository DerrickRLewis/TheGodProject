...
import apps.envision.mychurch.ui.viewholders.BranchesViewHolder;
...
public class BranchesAdapter extends RecyclerView.Adapter< RecyclerView.ViewHolder>{
    ...
    public BranchesAdapter(BranchClickListener branchClickListener) {
     ...
     * @param data
     */
    public void setAdapter(List<Branches> data) {
        items = new ArrayList<>();
        items.addAll(data);
    ...
    public void setMoreData(List<Branches> data) {
        items.addAll(data);
    ...
    public  RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            case VIEW_TYPE_USERDATA:
                View v = inflater.inflate(R.layout.branch, viewGroup, false);
                viewHolder = new BranchesViewHolder(v, branchClickListener);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
        switch (holder.getItemViewType()) {
            case VIEW_TYPE_USERDATA:
                final BranchesViewHolder viewHolder = (BranchesViewHolder) holder;
                final Branches ci = (Branches) items.get(i);
                viewHolder.bind(ci);
                break;
            case VIEW_TYPE_HEADER:
