...
public class EventsViewerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Gson gson = new Gson();
        events = gson.fromJson(getIntent().getStringExtra("events"), Events.class);
        String dateTime = getIntent().getStringExtra("date");

        if(events ==null || dateTime == null){
        ...
        ImageLoader.loadImageThumbnail(thumbnail,events.getThumbnail());
        if(events.getDetails().equalsIgnoreCase("")){
            try {
                fetchData();
            ...
            details.setHtml(events.getDetails(),
        ...
        callAsync.enqueue(new Callback<String>() {
            ...
            public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                ...
                try {
                    ...
                    events.setDetails(jsonObj.getString("content"));
