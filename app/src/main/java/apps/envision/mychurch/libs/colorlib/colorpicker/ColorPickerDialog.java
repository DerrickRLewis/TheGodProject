...
package apps.envision.mychurch.libs.colorlib.colorpicker;
...
public class ColorPickerDialog extends DialogFragment implements ColorPickerSwatch.OnColorSelectedListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if(PreferenceSettings.getBibleThemeMode()==1){
            dialogBuilder = new AlertDialog.Builder(activity,R.style.AlertDialogCustomLight);
        }else {
            dialogBuilder = new AlertDialog.Builder(activity,R.style.AlertDialogCustomDark);
        }
