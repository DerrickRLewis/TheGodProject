package apps.envision.mychurch.libs.materialbanner.adapter;
...
import apps.envision.mychurch.libs.materialbanner.view.indicator.IconPagerAdapter;
...
public class MaterialPageAdapter<T> extends PagerAdapter implements IconPagerAdapter {
    ...
    public MaterialPageAdapter(ViewHolderCreator holderCreator, List<T> datas, MediaClickListener mediaClickListener) {
    ...
    public View getView(int position, View view, ViewGroup container) {
        ...
        if (view == null) {
            ...
            view = holder.createView(container.getContext(),mediaClickListener);
