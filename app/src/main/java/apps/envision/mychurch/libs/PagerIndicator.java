package apps.envision.mychurch.libs;
    ...
    public void setViewPager(ViewPager viewPager) {
        ...
        viewPager.getAdapter().registerDataSetObserver(new DataSetObserver() {
            ...
            public void onChanged() {
                setPageCount(PagerIndicator.this.viewPager.getAdapter().getCount());
            }
        });
    ...
    private ValueAnimator createMoveSelectedAnimator(
        ...
        moveSelected.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                ViewCompat.postInvalidateOnAnimation(PagerIndicator.this);
            }
        });
