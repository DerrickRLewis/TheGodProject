...
package apps.envision.mychurch.libs.materialbanner;
...
import apps.envision.mychurch.libs.materialbanner.adapter.MaterialPageAdapter;
import apps.envision.mychurch.libs.materialbanner.holder.ViewHolderCreator;
import apps.envision.mychurch.libs.materialbanner.view.MaterialViewPager;
import apps.envision.mychurch.libs.materialbanner.view.indicator.PageIndicator;
...
public class MaterialBanner<T> extends FrameLayout {
    ...
    private LayoutParams mCardParams;
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        mIndicatorParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        mIndicatorParams.gravity = Gravity.CENTER;

        mCardParams = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
    ...
    static class AdSwitchTask implements Runnable {
        ...
        public void run() {
            ...
            if(materialBanner != null && materialBanner.mData.size()>0){
    ...
    public MaterialBanner setPages(ViewHolderCreator holderCreator, List<T> data, MediaClickListener mediaClickListener){
        this.mData = data;
        mPageAdapter = new MaterialPageAdapter(holderCreator, mData,mediaClickListener);
