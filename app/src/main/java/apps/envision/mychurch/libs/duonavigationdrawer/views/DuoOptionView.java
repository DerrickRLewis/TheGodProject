package apps.envision.mychurch.libs.duonavigationdrawer.views;
...
public class DuoOptionView extends RelativeLayout {
     ...
     */
    public void bind(String optionText, @Nullable Drawable selectorDrawable, boolean badge) {
        mOptionViewHolder.mTextViewOption.setText(optionText);
        mOptionViewHolder.mTextViewOption.setAlpha(ALPHA_UNCHECKED);
        ...
        if(badge){
            mOptionViewHolder.cart_badge.setVisibility(VISIBLE);
        }else{
            mOptionViewHolder.cart_badge.setVisibility(GONE);
        }
    }
    ...
    private class OptionViewHolder {
        ...
        OptionViewHolder(ViewGroup rootView) {
            ...
            cart_badge = rootView.findViewById(R.id.cart_badge);
