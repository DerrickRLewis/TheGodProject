...
import apps.envision.mychurch.ui.activities.BookmarkedHymnsActivity;
...
public class FollowUsersActivity extends AppCompatActivity implements LocalMessageCallback, UserProfileListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mSearchView.setQueryHint(getString(R.string.search_for_people));
    ...
    private void fetch_users(){
        try {
            ...
            Call<String> callAsync = service.get_users_to_follow(requestBody);
    ...
    public void view_profile(UserData userData) {
        ...
        intent = new Intent(FollowUsersActivity.this, UsersProfileActivity.class);
    ...
    public void finish_activity(View view){
        if(onboarder){
            startActivity(new Intent(FollowUsersActivity.this, SocialActivity.class));
        }
        finish();
    }
}
