...
public class UserPostsFragment extends Fragment implements UserPostsListener, LocalMessageCallback {
    ...
    private void fetch_posts(){
        try {
            ...
            Call<String> callAsync = service.fetch_posts(requestBody);
    ...
    public void handleMessage(@NonNull LocalMessage localMessage) {
        switch (localMessage.getId()){
            ...
            case R.id.update_post_comment_count:
                ...
                break;
            case R.id.update_user_likes_count:
                LikeUpdate likeUpdate =  (LikeUpdate) localMessage.getObject();
                if(likeUpdate!=null && likeUpdate.refresh) {
                    userPostAdapter.updatePostLikesCount(likeUpdate);
                }
                break;
