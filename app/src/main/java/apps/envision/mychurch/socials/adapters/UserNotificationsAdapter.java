...
import apps.envision.mychurch.ui.viewholders.UserNotificationsViewHolder;

/*
* adapter class to display list of our searched songs from soundcloud
 */
public class UserNotificationsAdapter extends RecyclerView.Adapter< RecyclerView.ViewHolder>{
    ...
    public UserNotificationsAdapter(UserNotificationListener userNotificationListener) {
     ...
     * @param data
     */
    public void setAdapter(List<UserNotifications> data) {
        items = new ArrayList<>();
        items.addAll(data);
    ...
    public void setMoreData(List<UserNotifications> data) {
        items.addAll(data);
    ...
    public  RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            case VIEW_TYPE_USERDATA:
                View v = inflater.inflate(R.layout.user_notification_item, viewGroup, false);
                viewHolder = new UserNotificationsViewHolder(v, userNotificationListener);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
        switch (holder.getItemViewType()) {
            case VIEW_TYPE_USERDATA:
                final UserNotificationsViewHolder viewHolder = (UserNotificationsViewHolder) holder;
                final UserNotifications ci = (UserNotifications)items.get(i);
