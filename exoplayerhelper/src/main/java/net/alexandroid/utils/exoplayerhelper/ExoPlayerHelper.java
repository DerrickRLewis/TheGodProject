...
public class ExoPlayerHelper implements
        ...
        AdsMediaSource.MediaSourceCaller,
    ...
    private void addProgressBar(int color) {
        ...
        mProgressBar.setIndeterminateDrawable(mContext.getDrawable(R.drawable.jz_loading));
...
/*            Log.e("ZAQ", "isCurrentWindowDynamic: " + mPlayer.isCurrentWindowDynamic());
    ...
    public long getCurrentPosition() {
        if (mPlayer != null) {
            Log.e("player",String.valueOf(mPlayer.getCurrentPosition()));
    ...
    public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
        ...
        switch (playbackState) {
            case Player.STATE_READY:
                if (playWhenReady) {
                    onPlayerPlaying();
                    mExoPlayerListener.onPlayerPlaying(mPlayer.getCurrentPosition());
                } else {
                    onPlayerPaused();
